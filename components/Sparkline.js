...
export function sparkline(svg, entries, options) {
  ...
  // interactionLayer.addEventListener("mousedown", mouseUpDown);
  interactionLayer.addEventListener("mouseup", mouseUpDown);
}
